...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'pr_question', 'question', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Question.question'
        db.alter_column(u'pr_question', 'question', self.gf('django.db.models.fields.CharField')(max_length=128))
