...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'projects_project', 'repo_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Project.travis_enabled'
        db.add_column(u'projects_project', 'travis_enabled',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'projects_project', 'repo_id')

        # Deleting field 'Project.travis_enabled'
        db.delete_column(u'projects_project', 'travis_enabled')
