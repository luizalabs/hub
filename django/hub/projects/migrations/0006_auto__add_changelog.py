...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_changelog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('email_recipients', self.gf('django.db.models.fields.TextField')()),
            ('email_subject', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='added_changelogs', to=orm['accounts.Account'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'projects', ['Changelog'])


    def backwards(self, orm):
        # Deleting model 'Changelog'
        db.delete_table(u'projects_changelog')
    ...
    models = {
        ...
        u'projects.changelog': {
            ...
            'email_recipients': ('django.db.models.fields.TextField', [], {}),
