...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changelog.email_sent'
        db.add_column(u'projects_changelog', 'email_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changelog.email_sent'
        db.delete_column(u'projects_changelog', 'email_sent')
