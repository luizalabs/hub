...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.leaving_date'
        db.alter_column(u'accounts_account', 'leaving_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Account.starting_date'
        db.alter_column(u'accounts_account', 'starting_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Account.leaving_date'
        db.alter_column(u'accounts_account', 'leaving_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Account.starting_date'
        db.alter_column(u'accounts_account', 'starting_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
