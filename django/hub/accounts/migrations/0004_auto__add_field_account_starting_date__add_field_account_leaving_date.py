...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.starting_date'
        db.add_column(u'accounts_account', 'starting_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.leaving_date'
        db.add_column(u'accounts_account', 'leaving_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.starting_date'
        db.delete_column(u'accounts_account', 'starting_date')

        # Deleting field 'Account.leaving_date'
        db.delete_column(u'accounts_account', 'leaving_date')
    ...
    models = {
        u'accounts.account': {
            ...
            'leaving_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'starting_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
